...
export default new Vuex.Store({
  ...
  actions: {
    ...
    async deleteUser ({ commit }, payload) {
      let status
      try {
        const res = await api.admin.deleteUser(payload)
        status = res.status
        commit('SET_BACKEND', true)
      } catch (error) {
        status = error.response.status
    ...
    async deleteProduct ({ commit }, payload) {
      let status
      try {
        const res = await api.moder.deleteProduct(payload)
        status = res.status
        commit('SET_BACKEND', true)
      } catch (error) {
        status = error.response.status
    ...
    async updateProduct ({ commit }, payload) {
      let data, status
      try {
        const res = await api.moder.updateProduct(payload)
        data = res.data
        status = res.status
        commit('SET_BACKEND', true)
      } catch (error) {
    ...
    async addProduct ({ commit }, payload) {
      let data, status
      try {
        const res = await api.moder.addProduct(payload)
        data = res.data
        status = res.status
        commit('SET_BACKEND', true)
      } catch (error) {
    ...
    async addOrder ({ commit }, payload) {
      let data, status
      try {
        const res = await api.user.addOrder(payload)
        data = res.data
        status = res.status
        commit('SET_BACKEND', true)
      } catch (error) {
