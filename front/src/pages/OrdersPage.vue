<template>
  <article class="orders">
    ...
    <ul class="orders__list">
      <li class="orders__list-element">
        <p class="orders__list-element-label orders__list-element-id">Номер заказа</p>
        <p class="orders__list-element-label orders__list-element-status">Статус</p>
        <p class="orders__list-element-label orders__list-element-description">Описание</p>
      </li>
